...
app.service('itunesService', function($http, $q){
  ...
  //Write a method that accepts an artist's name as the parameter, then makes a 'JSONP' http 
  //request to
...
// 	service.getMusic = function(artist) {
...
// 				var relevant = response.data.results;
// 				deferred.resolve(relevant);
// 		});
...
// 	return service;
   	...
   	this.artistName = function(artist) {
   		var deferred = $q.defer();
     	$http({
         	method: 'JSONP',
        	url: 'https:itunes.apple.com/search?term=' + artist + '&callback=JSON_CALLBACK'
